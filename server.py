...
def generate_script(api_key, title, description, language, niche="", provider="openai", frame_count=4):
    ...
    prompt = (
        ...
        f"- Use this exact {frame_count}-beat arc: strong hook/setup, problem/discovery, choice/action, visual payoff/ending.\n"
        ...
        "- Make the story clear from frame 1 to frame 4.\n"
